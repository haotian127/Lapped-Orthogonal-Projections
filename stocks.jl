...
#############
plt = approx_curves_now(G_Sig, Gstar_Sig, GP, GP_dual, VM_NGWP; frac = 0.5, ϵ = 0.9)
...
plot(frac*(0:(p-1))/(p-1), hcat(e1[1:p, 8], e2[1:p, 4], e3[1:p], e4[1:p]), yaxis=:log, xlims = (0.,frac),
